...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: <Github size={16} />, label: "github.exe", href: "https://github.com/abdelrahman-elkhateeb" },
    { icon: <Linkedin size={16} />, label: "linkedin.sh", href: "https://www.linkedin.com/in/abdelrahman-elkhateeb" },
    { icon: <Mail size={16} />, label: "contact.log", href: "elkhateebabdelrahman@email.com" },
  ];
        ...
        <div className="flex flex-wrap gap-4">
          {socialLinks.map((link, idx) => (
            <motion.a
              ...
              className="flex items-center gap-2 px-3 py-1.5 border border-border bg-card hover:bg-primary hover:text-primary-foreground transition-colors group shadow-[2px_2px_0px_0px_rgba(0,0,0,0.1)] dark:shadow-[2px_2px_0px_0px_var(--primary)]"
              whileHover={{ y: -2, x: -2, shadow: "none" }}
            >
